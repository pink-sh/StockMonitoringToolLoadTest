...
public class SbprRunner extends Runner implements Runnable {
	
	private String page = "sbpr";
	
	
	public SbprRunner(String baseUrl, Boolean shinyproxy, String chromedriver, String testFile) {
	...
	public void run() {
        ...
        WebElement uploadFile = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("sbprModule-fileSbpr")));
        ...
        WebElement runButton = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.elementToBeClickable(By.id("sbprModule-go_sbpr")));
