...
public class CmsyRunner extends Runner implements Runnable {
	
	private String page = "cmsy";
	
	
	public CmsyRunner(String baseUrl, Boolean shinyproxy, String chromedriver, String testFile) {
	...
	public void run() {
        ...
        WebElement uploadFile = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("cmsyModule-fileCmsy")));
        ...
        WebElement runButton = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.elementToBeClickable(By.id("cmsyModule-go_cmsy")));
