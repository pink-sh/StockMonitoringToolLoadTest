...
public class ElefanRunner extends Runner implements Runnable {
	
	private String page = "elefan";
	
	
	public ElefanRunner(String baseUrl, Boolean shinyproxy, String chromedriver, String testFile) {
	...
	public void run() {
        ...
        WebElement uploadFile = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("elefanModule-fileElefan")));
        ...
        WebElement runButton = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.elementToBeClickable(By.id("elefanModule-go")));
