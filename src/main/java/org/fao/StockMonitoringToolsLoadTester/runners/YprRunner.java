...
public class YprRunner extends Runner implements Runnable {
	
	private String page = "ypr";
	
	
	public YprRunner(String baseUrl, Boolean shinyproxy, String chromedriver, String testFile) {
	...
	public void run() {
        ...
        WebElement uploadFile = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("yprModule-fileYpr")));
        ...
        WebElement runButton = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.elementToBeClickable(By.id("yprModule-go_YPR")));
