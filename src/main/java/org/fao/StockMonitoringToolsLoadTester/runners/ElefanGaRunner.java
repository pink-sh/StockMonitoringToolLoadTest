...
public class ElefanGaRunner extends Runner implements Runnable {
	
	private String page = "elefan-ga";
	
	
	public ElefanGaRunner(String baseUrl, Boolean shinyproxy, String chromedriver, String testFile) {
	...
	public void run() {
        ...
        WebElement uploadFile = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.presenceOfElementLocated(By.id("elefanGaModule-fileGa")));
        ...
        WebElement runButton = new FluentWait<WebDriver>(driver)
        		...
        		.until(ExpectedConditions.elementToBeClickable(By.id("elefanGaModule-go_ga")));
